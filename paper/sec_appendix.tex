...
\caption{Per-stage change in F1 from adding spatial context, relative to the expression-only LR, for (A) neighbourhood-augmented LR and (B) GraphSAGE. Under species shift GraphSAGE loses 15 F1 points on round spermatids (RS), the most frequent human stage.}
\label{fig:perclass}
\end{figure}
